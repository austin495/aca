                ...
                <form id="leadForm" action='' method='post'>
                    <div class="form-content">
                        ...
                        <div class="HOUSEHOLDSIZE">
                            <label>Household Size: <span style="color: red;">*</span></label>
                            <select name="house_hold_size" id="house_hold_size" required>
                        ...
                        <div class="HOUSEHOLDINCOME">
                            <label>Household Income: <span style="color: red;">*</span></label>
                            <select name="house_hold_income" id="house_hold_income" required>
